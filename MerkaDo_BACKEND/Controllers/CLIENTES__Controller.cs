...
namespace MerkaDo_BACKEND.Controllers
{
    public class CLIENTES__Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ClienteId,nombreCliente,apellidoCliente,imagenCliente,teléfonoCliente,códigoPostalCliente,fechaNacimientoCliente,generoId,tipoDocumentoId,numeroDocumentoCliente,correoCliente,contraseñaCliente,estado,emailMarketing")] CLIENTES__ cLIENTES__)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ClienteId,nombreCliente,apellidoCliente,imagenCliente,teléfonoCliente,códigoPostalCliente,fechaNacimientoCliente,generoId,tipoDocumentoId,numeroDocumentoCliente,correoCliente,contraseñaCliente,estado,emailMarketing")] CLIENTES__ cLIENTES__)
        {
            if (ModelState.IsValid)
            {
