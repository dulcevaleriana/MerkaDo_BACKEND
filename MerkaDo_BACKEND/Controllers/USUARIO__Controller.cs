...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class USUARIO__Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "usuarioId,nombreUsuario,apellidoUsuario,imagenUsuario,cedulaUsuario,generoId,correoCorporativoUsuario,telefonoUsuario,sucursalId,rolId")] USUARIO__ uSUARIO__)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "usuarioId,nombreUsuario,apellidoUsuario,imagenUsuario,cedulaUsuario,generoId,correoCorporativoUsuario,telefonoUsuario,sucursalId,rolId")] USUARIO__ uSUARIO__)
        {
            if (ModelState.IsValid)
            {
