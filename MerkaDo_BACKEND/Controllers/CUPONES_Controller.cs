...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class CUPONES_Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "cuponesId,nombreCupones,descuentoCupones,precioDescontar,fechaVencimiento,codigoCupones")] CUPONES_ cUPONES_)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "cuponesId,nombreCupones,descuentoCupones,precioDescontar,fechaVencimiento,codigoCupones")] CUPONES_ cUPONES_)
        {
            if (ModelState.IsValid)
            {
