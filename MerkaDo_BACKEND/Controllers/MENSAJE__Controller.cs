...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class MENSAJE__Controller : Controller
    {
        ...
        {
            var mENSAJE__ = db.MENSAJE__.Include(m => m.SALA__).Include(m => m.TIPO_MENSAJE__).Include(m => m.TIPO_SALA__).Include(m => m.USUARIO__);
        ...
        public async Task<ActionResult> Create([Bind(Include = "mensajeId,usuarioId,salaId,mensaje,fecha,tipoMensajeId,tipoSalaId,url_link")] MENSAJE__ mENSAJE__)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "mensajeId,usuarioId,salaId,mensaje,fecha,tipoMensajeId,tipoSalaId,url_link")] MENSAJE__ mENSAJE__)
        {
            if (ModelState.IsValid)
            {
