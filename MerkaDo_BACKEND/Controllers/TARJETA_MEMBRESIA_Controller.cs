...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class TARJETA_MEMBRESIA_Controller : Controller
    {
        ...
        {
            var tARJETA_MEMBRESIA_ = db.TARJETA_MEMBRESIA_.Include(t => t.USUARIO__);
        ...
        public async Task<ActionResult> Create([Bind(Include = "tarjetaMembresiaId,usuarioId,nombreCliente,razonSocialEmpresa,puntosAcumuladosTarjetaMembresia,fechaVencimientoTarjetaMembresia")] TARJETA_MEMBRESIA_ tARJETA_MEMBRESIA_)
        {
            ...
            ViewBag.usuarioId = new SelectList(db.USUARIO__, "usuarioId", "nombreUsuario", tARJETA_MEMBRESIA_.usuarioId);
            return View(tARJETA_MEMBRESIA_);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "tarjetaMembresiaId,usuarioId,nombreCliente,razonSocialEmpresa,puntosAcumuladosTarjetaMembresia,fechaVencimientoTarjetaMembresia")] TARJETA_MEMBRESIA_ tARJETA_MEMBRESIA_)
        {
            if (ModelState.IsValid)
            {
