...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class NOTIFICACION_Controller : Controller
    {
        ...
        {
            var nOTIFICACION_ = db.NOTIFICACION_.Include(n => n.ROL_USUARIO).Include(n => n.TIPO_NOTIFICACION_).Include(n => n.USUARIO__);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.usuarioReceptorId = new SelectList(db.USUARIO__, "usuarioId", "nombreUsuario");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "notificacionId,rolId,tipoNotificacionId,usuarioReceptorId,mensajeNotificacion,fechaNotificacion")] NOTIFICACION_ nOTIFICACION_)
        {
            ...
            ViewBag.usuarioReceptorId = new SelectList(db.USUARIO__, "usuarioId", "nombreUsuario", nOTIFICACION_.usuarioReceptorId);
            return View(nOTIFICACION_);
        }
