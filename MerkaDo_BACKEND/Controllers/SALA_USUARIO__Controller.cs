...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class SALA_USUARIO__Controller : Controller
    {
        ...
        {
            var sALA_USUARIO__ = db.SALA_USUARIO__.Include(s => s.SALA__).Include(s => s.USUARIO__);
        ...
        public async Task<ActionResult> Create([Bind(Include = "salaUsuarioId,salaId,usuarioId")] SALA_USUARIO__ sALA_USUARIO__)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "salaUsuarioId,salaId,usuarioId")] SALA_USUARIO__ sALA_USUARIO__)
        {
            if (ModelState.IsValid)
            {
