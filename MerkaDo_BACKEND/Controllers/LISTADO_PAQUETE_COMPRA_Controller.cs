...
namespace MerkaDo_BACKEND.Controllers
{
    ...
    public class LISTADO_PAQUETE_COMPRA_Controller : Controller
    {
        ...
        {
            var lISTADO_PAQUETE_COMPRA_ = db.LISTADO_PAQUETE_COMPRA_.Include(l => l.CARRITO_COMPRAS_).Include(l => l.USUARIO__);
        ...
        public async Task<ActionResult> Create([Bind(Include = "listadoPaqueteCompraId,usuarioId,nombreCliente,razonSocialEmpresa,carritoComprasId,totalPago,estadoListadoPaqueteCompra,fechaCreacionPaqueteCompra,errorReportado,mensajePaqueteCompra,statusFirmaEntregaPaqueteCompra,firmaClientePaqueteCompra,ubicacionActualPaqueteCompra,ubicacionDestinoPaqueteCompra")] LISTADO_PAQUETE_COMPRA_ lISTADO_PAQUETE_COMPRA_)
        {
            ...
            ViewBag.usuarioId = new SelectList(db.USUARIO__, "usuarioId", "nombreUsuario", lISTADO_PAQUETE_COMPRA_.usuarioId);
            return View(lISTADO_PAQUETE_COMPRA_);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "listadoPaqueteCompraId,usuarioId,nombreCliente,razonSocialEmpresa,carritoComprasId,totalPago,estadoListadoPaqueteCompra,fechaCreacionPaqueteCompra,errorReportado,mensajePaqueteCompra,statusFirmaEntregaPaqueteCompra,firmaClientePaqueteCompra,ubicacionActualPaqueteCompra,ubicacionDestinoPaqueteCompra")] LISTADO_PAQUETE_COMPRA_ lISTADO_PAQUETE_COMPRA_)
        {
            if (ModelState.IsValid)
            {
